  ...
  return (
    <section className='sm:px-8 px-4  max-w-7xl mx-auto py-20 z-0'>
      <div>
        ...
        <p className='mt-2 text-secondary text-[16px] max-w-[500px]'>Browse through a collection of imaginative and visually stunning images generated by DALL-E AI </p>
      </div>
